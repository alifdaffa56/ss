...
poll = LinePoll(cl)
call = cl
creator = ["ufc99b69bc456161d9aaabeabab0ebc43"]
owner = ["ufc99b69bc456161d9aaabeabab0ebc43"]
admin = ["ufc99b69bc456161d9aaabeabab0ebc43"]
staff = ["ufc99b69bc456161d9aaabeabab0ebc43"]
...
#KICKALL
                        ...
                        elif "cannibal" in msg.text:
                           if msg._from in Bots:
                            if msg.toType == 2:
                             #  print "Otw cleanse"
                               _name = msg.text.replace("Rusuh","cannibal")
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttps://line.me/ti/p/IAHDhBMdRW")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kd.sendMessage(msg.to, "[[┄┅═CANNIBAL═┅┄]]")
                                ke.sendMessage(msg.to, "[[┄┅═CANNIBAL═┅┄]]")
                                kf.sendMessage(msg.to, "[[┄┅═CANNIBAL═┅┄]]")
                                kj.sendMessage(msg.to, "[[┄┅═CANNIBAL═┅┄]]")
...
#===========Hiburan============#
                        ...
                        elif cmd == "ckbot" or cmd == "ckbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "Pasukan  ┄┅═CANNIBAL═┅┄ Hadir")
