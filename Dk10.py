...
cl = LineClient(authToken="EDzjpK3PjaDdkJ1Kz1oc.J52q9ZereGq/WMcs+Y4iZa.4118D/3cP14Rz7ZVY9p64kYaCAx6oquucDS7yKaBeIM=")
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken="EDj7BW6DDeEFI8QZe449.ZhnnJISK60L7Kp0ZTlf5oq.VTf61JOT5+9FIBmjKZEvKTEh9/C4jIHGGHMH8JRFxiM=")
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Channel Access Token : " + str(channel.channelAccessToken))

kk = LineClient(authToken="EDpxud1XbyONgxNqRKM4.iX+pImHExPlITbhk+wUd9a.TuN3kLyhlst9M3hdBPUgKhnbx19LFI7BOCx+YWva3Lw=")
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Channel Access Token : " + str(channel.channelAccessToken))

kc = LineClient(authToken="EDrmMhjCO7KROYYMfQ0f.ju5e3fc15DEZFqiC5nNhFW.b3HbaTnJ8jZo/qN0wkMX+TJFEXxfceFlyJiINuPP4aE=")
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Channel Access Token : " + str(channel.channelAccessToken))

kb = LineClient(authToken="EDpKwm4YunX2LDrNn8z4.lm4NXyAZhthti5Qgc7G9va.kP10uwLnR2MibI0s7aGxOm/K17CZWEPhV90Axpl/AXc=")
kb.log("Auth Token : " + str(kb.authToken))
kb.log("Channel Access Token : " + str(channel.channelAccessToken))

kd = LineClient(authToken="ED08CcjyNnjWv63xtgN5.3cENFElXIh1GoDouaScpPq.2xLZPpVCbn815dTOp3Uhn50chnZcU0/eNz7tYERV8+E=")
kd.log("Auth Token : " + str(kd.authToken))
kd.log("Channel Access Token : " + str(channel.channelAccessToken))

ke = LineClient(authToken="ED75eyfzrlHrh4PolgB6.jXRR+4OlGw2xVKEmwBFPDG.LiKTSC5Ln6Vsj07qb+IgmWvpaubqQoL0IdCsEwPQJfw=")
ke.log("Auth Token : " + str(ke.authToken))
ke.log("Channel Access Token : " + str(channel.channelAccessToken))

kf = LineClient(authToken="EDGSDv6eIiGpY6pPfBc8.B1qoQbaHGNNV40dRRujYwa.WscpTZHPnRYkIiNcCpl/3TkfQxtszr78sNbdl9ViLn0=")
kf.log("Auth Token : " + str(kf.authToken))
kf.log("Channel Access Token : " + str(channel.channelAccessToken))

kj = LineClient(authToken="EDP5YNhiJK4xsDL3kijf.QQ8hqm5fbUt0Cv9rO20bZW.z8MCE1g9FdpX2vYylpQOGdv9KJ+s0SsBC59nDEkEndM=")
kj.log("Auth Token : " + str(kj.authToken))
kj.log("Channel Access Token : " + str(channel.channelAccessToken))

sw = LineClient(authToken="EDQCjMJQ6lXVXExxjSKa.QWE8/oATplLaAvgAlqXd2G.A7+ACoB2zjS10LyYHeRC9bMmgNQJDC6hdan8de32NbM=")
...
poll = LinePoll(cl)
call = cl
creator = ["u8f9d90f7311112043ec26092ff2e08cc"]
owner = ["u8f9d90f7311112043ec26092ff2e08cc"]
admin = ["u8f9d90f7311112043ec26092ff2e08cc"]
staff = ["u8f9d90f7311112043ec26092ff2e08cc"]
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "❂͜͡➣ " + key + " [MENU GROUP]\n" + \
                  "❂͜͡➣ " + key + "ᴛᴀɢᴀʟʟ/ɴᴀʜ\n" + \
                  "❂͜͡➣ " + key + "ɢɪɴғᴏ\n" + \
                  "❂͜͡➣ " + key + "ᴏᴘᴇɴ\n" + \
                  "❂͜͡➣ " + key + "ᴄʟᴏsᴇ\n" + \
                  ...
                  "❂͜͡➣ " + key + "sᴘᴀᴍᴄᴀʟʟ:「ᴊᴜᴍʟᴀʜɴʏᴀ」\n" + \
                   ...
                   "「」  ʙʏ: Alif\n" + \
                   "  Creator:  https://line.me/ti/p/tpskRWpART"
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttps://line.me/ti/p/tpskRWpART")
                        ...
                        elif cmd == "absen" or cmd == "dkbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[🔰 Pasukan].")
                               elapsed_time = time.time() - start
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttps://line.me/ti/p/tpskRWpART")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[🔰 team1")
                                ki.sendMessage(msg.to, "[🔰 team2")
                                kk.sendMessage(msg.to, "[🔰 team3")
                                kc.sendMessage(msg.to, "[🔰 team4")
                                kb.sendMessage(msg.to, "[🔰 team5")
                                kd.sendMessage(msg.to, "[🔰 team6")
                                ke.sendMessage(msg.to, "[🔰 team7")
                                kf.sendMessage(msg.to, "[🔰 team8")
                                kj.sendMessage(msg.to, "[🔰 team9")
                                sw.sendMessage(msg.to, "[🔰 team10")
                                cl.sendMessage(msg.to, "╔═══╗\n║╔═╗║\n║║─║╠╗╔╦══╦═╗\n║╚═╝║╚╝║╔╗║╔╗╗\n║╔═╗║║║║╔╗║║║║\n╚╝─╚╩╩╩╩╝╚╩╝╚╝")
...
#===========Hiburan============#
                        ...
                        elif cmd == "bot" or cmd == "dkbots":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "Pasukan Canninal Hadir")
                                ki.sendMessage(msg.to, "Pasukan Cannibal Hadir")
                                kk.sendMessage(msg.to, "Pasukan Cannibal Hadir")
                                kc.sendMessage(msg.to, "Pasukan Cannibal Hadir")
                                kb.sendMessage(msg.to, "Pasukan Cannibal Hadir")
                                kd.sendMessage(msg.to, "Pasukan Cannibal Hadir")
                                ke.sendMessage(msg.to, "Pasukan Cannibal Hadir")
                                kf.sendMessage(msg.to, "Pasukan Cannibal Hadir")
                                kj.sendMessage(msg.to, "Pasukan Cannibal Hadir")
                                sw.sendMessage(msg.to, "Pasukan Cannibal Hadir")
                                cl.sendMessage(msg.to, "All pasukan Cannibal Hdir\nAmankan Room\nDemi Amanat Bos Q")
                        ...
                        elif cmd == "myteam" or text.lower() == 'contact bot':
                            if msg._from in admin:
                                ma = ""
                                for i in Bots:
                                    ma = cl.getContact(i)
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                             cl.sendMessage(msg.to,"──────┅❇͜͡❇͜͡☆͜͡❇͜͡❇┅──────\nᴼᴾᴱᴺ ᴼᴿᴰᴱᴿ\n────────┅┅───────\n➣ꜱᴇʟꜰʙᴏᴛ ᴏɴʟʏ\n➣ꜱᴇʟꜰʙᴏᴛ + ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 2 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 3 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 4 ᴀꜱɪꜱᴛ\n➣1 ᴀᴋᴜɴ ᴜᴛᴀᴍᴀ + 5 ᴀꜱɪꜱᴛ\n➣ʙᴏᴛᴘʀᴏᴛᴇᴄᴛ 3-11 ʙᴏᴛ ᴀꜱɪꜱᴛ\n➣ɴᴇᴡ ꜱᴄʀɪᴘᴛ\n➣ʜʀɢᴀ ʙɪꜱᴀ ɴᴇɢᴏ\n─────────┅┅─────────\n  ✯❇͜͡❇͜͡C͜͡r͜͡e͜͡a͜͡t͜͡o͜͡r✯͜͡$͜͡ë͜͡I͜͡F͜͡-͜͡฿͜͜͡͡o͜͡t͜͡ ͜͡❇͜͡❇✯\nhttps://line.me/ti/p/tpskRWpARTn➣ѕєʟғвот κɪcκєʀ_+_ᴘʀᴏᴛᴇᴄᴛ\n────────┅❇͜͡❇͜͡☆͜͡❇͜͡❇┅────────")
                             msg.contentType = 13
